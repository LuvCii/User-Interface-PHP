							...
							<div class="item active">
								<div class="col-sm-6">
									<h1><span>X</span>-SHOP</h1>
									 <!-- <h2>Những sản phẩm đẹp nhất sẽ có tại đây</h2> -->
						...
						<div class="brands_products">
							...
							<div class="box">
								<form class="sbox" action="" method="POST">
									<input class="stext" type="text" name="name" placeholder="Nhập tên sản phẩm...">
				...
				<div class="row">
					<div class="col-sm-2">
						<div class="companyinfo">
							...
							<p>Luôn mang đến cho các bạn cảm giác thoải mái nhất với phong cách hàng đầu về trang phục</p>
						</div>
					</div>
					<div class="col-sm-7">
						<div class="col-sm-3">
